      ...
      <DialogPrimitive.Portal>
        <DialogPrimitive.Content 
          className={cn(
            ...
            "rounded-xl border-0 bg-transparent shadow-none duration-200",
        ...
        >
          ...
          {/* Drag handle */}
          <div 
            className="absolute left-0 right-0 top-0 h-10 flex items-center justify-center cursor-move rounded-t-xl hover:bg-black/10 dark:hover:bg-white/10"
          ...
          <DialogPrimitive.Close 
            className="absolute right-3 top-3 z-10 rounded-xl opacity-70 transition-opacity hover:opacity-100 focus:outline-none cursor-pointer bg-black/10 hover:bg-black/20 dark:bg-white/10 dark:hover:bg-white/20 p-1"
          >
